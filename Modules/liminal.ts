...
export const nightmares: NightmareInfo[] = [
    ...
    new NightmareInfo(1, "Mari the poisonbearer", "summer2025", 40_000, nightmareMobs[1], { accentColor: "#b495a4ff", preSelectedChar: 2080 }),
    ...
    // will change to shorekeeper ex id once added
    new NightmareInfo(7, "Victoria the Dragonslayer", "summer2025", 50_000, nightmareMobs[7], { accentColor: "#c26d57ff", preSelectedChar: 1 }), 
