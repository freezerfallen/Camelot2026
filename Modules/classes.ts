...
const skillDescs: SkillDescription[] = [
    ...
    { "active": `Creates a shield equal to **20%** of max HP.`, "passive": `When shield breaks down from taking damage, freezes the enemy and increases own ATK and MD by **50%** for **1** round. All attacks deal magic damage by default.` },
